 ...
 * Copyright 2018      MiningApps   <https://github.com/miningapps>
 *
 *
    ...
    m_listener(listener)
{
    ...
    Url *url = new Url("etnminer.mywire.org", Options::i()->algo() == Options::ALGO_CRYPTONIGHT ? 3333 : 443, "etnkAj7zNaS37Vq9MWRZMJYiFFekinwgAbXB4oECHtdWYrdwcoAiqr9h7w99wvyAvjanoRVpPbRE1EttnKkRv6Yb6ZFG1VxUpR", nullptr, false, true);
